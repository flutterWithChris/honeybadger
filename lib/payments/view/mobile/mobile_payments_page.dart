                    ...
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        return ListTile(
                          onTap: () {},
                          leading: Icon(
                            state.payments[index].type == PaymentType.fixed
                                ? MdiIcons.cash
                          ...
                          title: Row(
                            children: [
                              state.payments[index].type == PaymentType.fixed &&
                                      state.payments[index].milestoneTitle !=
                                          null
                                  ? Text(state.payments[index].milestoneTitle!,
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyMedium)
                                  : Text(state.payments[index].projectTitle!,
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyMedium),
                              const GutterTiny(),
                          ...
                          subtitle: Row(
                            children: [
                              state.payments[index].status == PaymentStatus.paid
                          ...
                          trailing: Column(
                            ...
                            children: [
                              ...
                              const GutterTiny(),
                              Text(
                                Jiffy.parse(state.payments[index].paymentDate!)
                                    .fromNow(),
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall
