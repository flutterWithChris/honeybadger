...
class DesktopProfileSetup extends StatefulWidget {
  final PageController pageController;
  const DesktopProfileSetup({required this.pageController, super.key});

  @override
  State<DesktopProfileSetup> createState() => _DesktopProfileSetupState();
}

class _DesktopProfileSetupState extends State<DesktopProfileSetup> {
