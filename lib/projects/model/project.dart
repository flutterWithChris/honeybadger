...
class Project {
  ...
  Project copyWith({
    ...
    return Project(
      ...
      clientReviewCount: clientReviewCount ?? this.clientReviewCount,
      clientTotalSpend: clientTotalSpend ?? this.clientTotalSpend,
      clientLocation: clientLocation ?? this.clientLocation,
      clientProfilePicture: clientProfilePicture ?? this.clientProfilePicture,
      clientIndustry: clientIndustry ?? this.clientIndustry,
      ...
      weekEstimate: weekEstimate ?? this.weekEstimate,
      hoursPerWeek: hoursPerWeek ?? this.hoursPerWeek,
      hoursTotal: hoursTotal ?? this.hoursTotal,
      proposalCount: proposalCount ?? this.proposalCount,
      unreadProposalCount: unreadProposalCount ?? this.unreadProposalCount,
